...
<table class="table table-sm">
	<tr>
		<th scope="row">
			<acme:print code="manager.dashboard.form.label.average-number-jobs-employer"/>
		</th>
		<td>
	...
	<tr>
		<th scope="row">
			<acme:print code="manager.dashboard.form.label.average-number-applications-worker"/>
		</th>
		<td>
	...
	<tr>
		<th scope="row">
			<acme:print code="manager.dashboard.form.label.average-number-applications-employer"/>
		</th>
		<td>
