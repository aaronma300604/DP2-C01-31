...
<acme:form>
	<acme:input-textbox code="authenticated.customer.form.label.phone" path="phone" placeholder = "+34123456789"/>
	...
	<acme:input-integer code="authenticated.customer.form.label.points" path="points"/>
