...
<acme:form> 
	...
	<acme:input-integer code="administrator.service.form.label.avgDwellTime" path="avgDwellTime"/>	
	...
	<acme:input-money code="administrator.service.form.label.discountApplied" path="discountApplied"/>
